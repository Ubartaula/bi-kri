...
const TimeDifferenceDisplay = ({ date }) => {
  ...
  return (
    <div className=" mx-1 text-blue-900  text-xs italic pl-0 p-1 pt-0 pb-0 flex flex-row overflow-hidden text-ellipsis whitespace-nowrap">
      <>
        {years >= 1 ? (
          <div>
            {years > 0 && (
...
export default React.memo(TimeDifferenceDisplay);
